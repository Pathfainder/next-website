...
const editUrl = (path: string) =>
  `${siteMetadata.siteRepo}/blob/main/data/ai-generated${path}`
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/blog/ai-tools/${post.slug}`,
    },
    openGraph: {
      title: post.title,
      description: post.summary,
      type: "article",
      url: `/blog/ai-tools/${post.slug}`,
      images: [
        {
